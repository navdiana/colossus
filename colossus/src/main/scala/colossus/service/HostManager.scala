...
case class LinearBackoff(pause: Duration = 100.milliseconds) extends LBBackoff
case class ExponentialBackoff(initial: Duration = 1.milliseconds, max: Duration = 1.second) extends LBBackoff
